...
async function decrypt(input) {
    try {
        ...
        console.log('Remaining Time:', (payload.exp * 1000 - Date.now())/1000,'s');
        console.log("timeout",JWT_TIMEOUT);
        console.log('is', payload.exp * 1000 - Date.now() < process.env.JWT_REFRESH);
