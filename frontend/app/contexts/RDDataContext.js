  ...
  useEffect(() => {
    ...
    if (datafromapiprofile.bd) {
      ...
      setFormData((prevData) => ({
        ...
        follower1_housenum: datafromapimilitary.addresses?.Follwer_address1.house_num,
        follower1_housemoo: datafromapimilitary.addresses?.Follwer_address1.house_moo,
        follower1_soi: datafromapimilitary.addresses?.Follwer_address1.soi,
        follower1_subdistrict: datafromapimilitary.addresses?.Follwer_address1.subdistrict,
        follower1_district: datafromapimilitary.addresses?.Follwer_address1.district,
        follower1_province: datafromapimilitary.addresses?.Follwer_address1.province,
        follower1_postal_code: datafromapimilitary.addresses?.Follwer_address1.postal_code,
        ...
        follower2_housenum: datafromapimilitary.addresses?.Follwer_address2.house_num,
        follower2_housemoo: datafromapimilitary.addresses?.Follwer_address2.house_moo,
        follower2_soi: datafromapimilitary.addresses?.Follwer_address2.soi,
        follower2_subdistrict: datafromapimilitary.addresses?.Follwer_address2.subdistrict,
        follower2_district: datafromapimilitary.addresses?.Follwer_address2.district,
        follower2_province: datafromapimilitary.addresses?.Follwer_address2.province,
        follower2_postal_code: datafromapimilitary.addresses?.Follwer_address2.postal_code,
      }));
    }
