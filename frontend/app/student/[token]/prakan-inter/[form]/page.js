    ...
    if (form === "0") {
      axios
        ...
        .then((response) => {
          ...
          router.push(`/student/${token}/prakan-inter/checkPrakan/${response.data.data.id}/0`);
        })
        .catch((error) => {
      ...
      axios
        ...
        .then((response) => {
          console.log("Form submitted successfully:", response.data);
          router.push(
            `/student/${token}/prakan-inter/checkPrakan/${response.data.data.id}/${response.data.data.req_id}`
          );
        })
        .catch((error) => {
          console.error("Error submitting form:", error);
          ...
          <main className="flex justify-center bg-white w-full">
            <div className="bg-white  w-full min-w-screen-6xl">
              ...
              <div className="flex justify-between mt-8">
                {/*TODO Edit Link*/}
                <a onClick={()=>{
                  router.push(`/student/${token}/home`)
                }
                }>
