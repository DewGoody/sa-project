        ...
        <>
            ...
            >
                {statusUid === 'จองคิวสำเร็จ' ? (
                    <Button type="primary" style={{backgroundColor:"#f687b3 "}} onClick={() => router.push(`/student/${token}/home`)}>
                        กลับหน้าแรก (Back to homepage)
                    </Button>
                ) : (
                    <Button type="primary" style={{backgroundColor:"#f687b3 "}} onClick={() => router.push(`/student/${token}/appointment/${id}/0`)}>
