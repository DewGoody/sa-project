              ...
              <form onSubmit={handleSubmit}>
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-4 pt-10 pb-2 ">
                    คำรับรองและคำยินยอมของผู้รายงานตัว (Declaration and consent
                    of the reporter)
                  </h3>
                </div>
                <div className="flex flex-col space-y-4 w-full">
                  <div className="flex items-start space-x-2">
                    ...
                    <label htmlFor="registermyself" className="text-gray-700">
                      สมัครใจเข้ารับการฝึกวิชาทหาร (Voluntary enlistment for
                      military training)
                    </label>
                  </div>
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <label htmlFor="notmilitary" className="text-gray-700">
                      ไม่เป็นทหารประจำการ กองประจำการ
                      หรือถูกกำหนดตัวเข้ากองประจำการ (Not being a regular
                      soldier, active duty or being assigned to active duty)
                    </label>
                  </div>
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <label htmlFor="man_right" className="text-gray-700">
                      ชาย ไว้ทรงผมรองทรงสูง ความยาวด้านบนไม่เกิน ๕ ซม.
                      หรือสั้นกว่า (Men have a high crew cut hairstyle with the
                      top length not exceeding 5 cm. or shorter.)
                    </label>
                  </div>
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <label htmlFor="women_right" className="text-gray-700">
                      หญิง ไว้ทรงผมตามที่ระเบียบกำหนด (Women must have their
                      hair style as prescribed by the regulations.)
                    </label>
                  </div>
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <label htmlFor="ready_right" className="text-gray-700">
                      พร้อมปฏิบัติตามเงื่อนไขบังคับในการสมัครเป็น นศท.ทุกประการ
                      (Ready to comply with all the mandatory conditions for
                      applying for ROTC.)
                    </label>
                  </div>
                </div>
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-4 pt-10 pb-2 ">
                    คำยินยอมของบิดา มารดา หรือผู้ปกครอง (Consent of father,
                    mother or guardian)
                  </h3>
                </div>
                <div className="flex space-x-4 w-full pb-2">
                  <div className="flex items-center space-x-4 w-1/2 ">
                    ...
                    />
                    <label
                      htmlFor="Parentconsent1"
                      className="block text-gray-700"
                    >
                      ให้ผู้สมัคร สมัครเป็น นศท.ชั้นปีที่ 1 ในปีการศึกษานี้
                      (Allow the applicant to enroll as a first-year ROTC
                      student in this academic year)
                    </label>
                  </div>
                  <div className="flex items-center space-x-4 w-1/2 ">
                    <input
                    ...
                    />
                    <label
                      htmlFor="Parentconsent2"
                      className="block text-gray-700"
                    >
                      ให้ผู้สมัคร ทดสอบสมรรถภาพร่างกาย เพื่อเป็น นศท.
                      และฝึกวิชาทหาร เมื่อได้รับการคัดเลือก (Allow the applicant
                      to test physical fitness to be a ROTC and military
                      training when selected)
                    </label>
                  </div>
                </div>
